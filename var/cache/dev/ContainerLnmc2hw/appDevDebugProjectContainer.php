...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\eventlistener\\apiproblemexceptionlistener' => 'AppBundle\\EventListener\\ApiProblemExceptionListener',
        ...
        $this->fileMap = array(
            'AppBundle\\Controller\\AnimalController' => __DIR__.'/getAnimalControllerService.php',
            'AppBundle\\Controller\\DefaultController' => __DIR__.'/getDefaultControllerService.php',
            'AppBundle\\EventListener\\ApiProblemExceptionListener' => __DIR__.'/getApiProblemExceptionListenerService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\EventListener\\ApiProblemExceptionListener' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('WKZpo6GA6t', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UxBjYBMN1n', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7jGF8RUBon', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zF4Pu-LHzb', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', array(0 => function () {
            return ${($_ = isset($this->services['AppBundle\EventListener\ApiProblemExceptionListener']) ? $this->services['AppBundle\EventListener\ApiProblemExceptionListener'] : $this->services['AppBundle\EventListener\ApiProblemExceptionListener'] = new \AppBundle\EventListener\ApiProblemExceptionListener()) && false ?: '_'};
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('09f7c930a7e724c752ea4ff45cc1b03e86cf114e')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('09f7c930a7e724c752ea4ff45cc1b03e86cf114e');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'web_services_rest_api',
            'database_user' => 'root',
            ...
            'secret' => '09f7c930a7e724c752ea4ff45cc1b03e86cf114e',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '09f7c930a7e724c752ea4ff45cc1b03e86cf114e',
